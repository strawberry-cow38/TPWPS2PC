...
Updated: 2026-09-24 UTC. Current priority: native entrance-group and departure-pressure guest lifecycle. Bus integration and requested presentation smoothing are shipped; the research branch now has an opt-in incoming controller through actual bus births, queues and fees, and normal rejected guests now walk back to the bus stop under an explicitly incomplete activation-phase adapter. Native route-service/readiness, fee overrides, ordinary recovery and complete activation/pressure population remain release blockers. Destination scoring, relief, shop walking and Bouncy's explicit hide-list activation are shipped; do not redo them. Exact commits, evidence and remaining boundaries are in progress.md. Cow tools owns the active RMB/listbox and shop-info UI work. The original `0db3678` starting point is historical.
