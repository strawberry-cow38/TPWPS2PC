...
M0 is ready to publish: completion plan, handoff ledger, and the tested ride-availability patch.
...
* Fetched upstream through `f9d1035` and rebased the eligibility patch to `4889ea1` (formerly local-only `326279e`). No force push and no discarded upstream changes.
